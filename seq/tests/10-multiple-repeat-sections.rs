...
fn main() {
    let interrupt1 = Interrupt1::Irq8;
    let interrupt2 = Interrupt2::Irq12;

    assert_eq!(interrupt1 as u8, 8);
    assert_eq!(interrupt1, Interrupt1::Irq8);
    assert_eq!(interrupt2 as u8, 12);
    assert_eq!(interrupt2, Interrupt2::Irq12);
}
